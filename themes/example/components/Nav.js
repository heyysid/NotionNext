...
export const Nav = (props) => {
  ...
  return (
    <nav className="w-full bg-white md:pt-0 px-6 relative z-20 border-t border-b border-gray-light dark:border-hexo-black-gray dark:bg-black">
      <div className="container mx-auto max-w-4xl md:flex text-sm sm:text-base">
        <ul className="flex text-nowrap absolute top-1 right-2 md:right-1 sm:right-2 lg:right-4">
