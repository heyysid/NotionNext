...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/d9bc497cd60945b78dfcf79bd78dc9c6
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'd9bc497cd60945b78dfcf79bd78dc9c6',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '肆意生长，无限蔓延',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '户外摄影、骑行、背包徒步、业余无线电，马督工粉丝', // 作者简介
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,weibo,email,twitter,telegram', // 分享的服務，按顺序显示,逗号隔开
  ...
  DESCRIPTION:
        process.env.Home || '这是一个由NotionNext生成的站点', // 站点描述，被notion中的页面描述覆盖
