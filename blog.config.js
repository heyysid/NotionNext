...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/d9bc497cd60945b78dfcf79bd78dc9c6
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    'd9bc497cd60945b78dfcf79bd78dc9c6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Li ZhongPing.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '户外摄影、骑行、背包徒步、业余无线电', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lizhongping.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '户外,徒步,摄影,骑行,背包徒步,业余无线电,HDR,PT', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'heyysid@icloud.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/7634700709', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/lizhongping_/', // 您的instagram地址
  ...
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 8290, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,weibo,email,twitter,telegram,messenger,reddit,whatsapp', // 分享的服務，按顺序显示,逗号隔开
  ...
  POST_DISABLE_GALLERY_CLICK:
    process.env.NEXT_PUBLIC_POST_DISABLE_GALLERY_CLICK || true, // 画册视图是否可点击，禁止方便在友链页面的画册插入链接
  ...
  CHATBASE_ID: 'fl28_RqcR8r7cSoSou5rE' || null,
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://www.twikoo.lizhongping.asia', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-618M847CY1', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-6804518683260201', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'lizhongping', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
