...
const Hualang = () => {
  ...
  const images = [
    ...
    { src:'/白沙湖2原图.JPG', title:'白沙湖2原图', description:'null' },
    { src:'/G219新藏线往新疆方向（暖）sRGBJPG10.JPG', title:'G219新藏线往新疆方向', description:'2024年6月11日在G219新藏线往新疆方向' },
    { src:'/摩托车公路电影色调.JPG', title:'摩托车公路电影色调', description:'null' },
    { src:'/在赛里木湖遇见的小姑娘.JPG', title:'在赛里木湖遇见的小姑娘', description:'null' },
    { src:'/在珠峰东坡嘎玛沟遇见的小孩.JPG', title:'在珠峰东坡嘎玛沟遇见的小孩', description:'null' },
    ...
    { src:'/乌鲁木齐sRGBJPG101.JPG', title:'乌鲁木齐的酒吧', description:'null' },
